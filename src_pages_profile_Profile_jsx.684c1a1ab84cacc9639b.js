...
/***/ "./src/components/modals/progress-modal/helper.js":
/*!********************************************************!*\
  !*** ./src/components/modals/progress-modal/helper.js ***!
  \********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   fetchAuthorAndQuote: () => (/* binding */ fetchAuthorAndQuote)
/* harmony export */ });
/* harmony import */ var _api_apiHelper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../api/apiHelper */ "./src/api/apiHelper.js");
/* harmony import */ var _store_reducers_AuthorReducer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../store/reducers/AuthorReducer */ "./src/store/reducers/AuthorReducer.js");
/* harmony import */ var _store_reducers_QuoteReducer__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../store/reducers/QuoteReducer */ "./src/store/reducers/QuoteReducer.js");
...
var fetchAuthorAndQuote = function fetchAuthorAndQuote(setAuthor, dispatch, setTimer, setAuthorQuote) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0,_api_apiHelper__WEBPACK_IMPORTED_MODULE_0__.fetchAuthor)(token);
          case 3:
          ...
          case 7:
            ...
            setAuthor(name);
            dispatch((0,_store_reducers_AuthorReducer__WEBPACK_IMPORTED_MODULE_1__.setAuthorId)(authorId));
            dispatch((0,_store_reducers_AuthorReducer__WEBPACK_IMPORTED_MODULE_1__.setAuthorName)(name));
            resolve(authorId);
            _context.next = 16;
            break;
          case 15:
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return (0,_api_apiHelper__WEBPACK_IMPORTED_MODULE_0__.fetchQuote)(authorId, token);
          case 3:
            ...
            dispatch((0,_store_reducers_QuoteReducer__WEBPACK_IMPORTED_MODULE_2__.setQuote)(quote));
            dispatch((0,_store_reducers_QuoteReducer__WEBPACK_IMPORTED_MODULE_2__.setQuoteId)(quoteId));
            setTimer(null);
            _context2.next = 13;
            break;
          case 12:
...
/* harmony import */ var _helper__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./helper */ "./src/components/modals/progress-modal/helper.js");
...
var useFetchAuthorAndQuote = function useFetchAuthorAndQuote() {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    (0,_helper__WEBPACK_IMPORTED_MODULE_1__.fetchAuthorAndQuote)(setAuthor, dispatch, setTimer, setAuthorQuote);
  }, []);
  return {
...
/* harmony import */ var _store_thunks__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../store/thunks */ "./src/store/thunks.js");
function _slicedToArray(r, e) { return _arrayWithHoles(r) || _iterableToArrayLimit(r, e) || _unsupportedIterableToArray(r, e) || _nonIterableRest(); }
function _nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function _unsupportedIterableToArray(r, a) { if (r) { if ("string" == typeof r) return _arrayLikeToArray(r, a); var t = {}.toString.call(r).slice(8, -1); return "Object" === t && r.constructor && (t = r.constructor.name), "Map" === t || "Set" === t ? Array.from(r) : "Arguments" === t || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t) ? _arrayLikeToArray(r, a) : void 0; } }
function _arrayLikeToArray(r, a) { (null == a || a > r.length) && (a = r.length); for (var e = 0, n = Array(a); e < a; e++) n[e] = r[e]; return n; }
...
var useProfile = function useProfile() {
  ...
  var quote = (0,react_redux__WEBPACK_IMPORTED_MODULE_2__.useSelector)(function (state) {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    ...
    settoken(token);
    dispatch((0,_store_thunks__WEBPACK_IMPORTED_MODULE_1__.fetchProfile)(token)).then(function (response) {
      if (response) {
...
//# sourceMappingURL=src_pages_profile_Profile_jsx.684c1a1ab84cacc9639b.js.map